...
| 5 | **polecat-app (chat)** | L | Adopt shell AND execute the chat.polecat.live rename per DOMAINS.md (export/handoff first, redirect stub after). Its marketing copy moves from the polecat repo. |
